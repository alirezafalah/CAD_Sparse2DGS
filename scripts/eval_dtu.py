...
parser.add_argument("--output_path", default="./exp_dtu/release")
parser.add_argument('--dtu', "-dtu", default="dtu_2dgs_path", type=str)
...
if not args.skip_metrics:
    parser.add_argument('--DTU_Official', "-DTU", default='', type=str)
...
if not args.skip_metrics:
    ...
    for scene in dtu_scenes:
        scan_id = scene[4:]
        ply_file = f"{args.output_path}/{scene}/train/ours_7000/"
        iteration = 7000
        string = f"python {script_dir}/eval_dtu/evaluate_single_scene.py " + \
            f"--input_mesh {args.output_path}/{scene}/train/ours_7000/fuse_post.ply " + \
